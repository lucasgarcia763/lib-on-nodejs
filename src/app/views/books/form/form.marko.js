...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/lib-on-nodejs$1.0.0/src/app/views/books/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Add new books</h1><form action=\"/books\" method=\"post\"><input type=\"hidden\" id=\"id\" name=\"id\" value=\"" +
...
marko_template.meta = {
    id: "/lib-on-nodejs$1.0.0/src/app/views/books/form/form.marko",
    tags: [
